// Murder Mystery.cpp : アプリケーションのエントリ ポイントを定義します。
//
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MURDERMYSTERY, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MURDERMYSTERY));
